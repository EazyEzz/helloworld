...
int main(int argc, const char *argv[]){
    ...
    if(pid < 0){
        ...
        return 2;
    } else if (pid == 0){ //Child reads from message queue
        char buf[ret_attr.mq_msgsize];
        unsigned int prio;
        ...
        */
        ...
        write(STDOUT_FILENO, "Parent: msg 1 send\n", 19);
